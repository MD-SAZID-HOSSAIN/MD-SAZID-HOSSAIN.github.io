...
(function() {
   ...
   * Skills Animation
   */
  let skillsAnimation = document.querySelectorAll('.skills-content');
  skillsAnimation.forEach((item) => {
    new Waypoint({
      element: item,
      offset: '80%',
      handler: function(direction) {
        let progress = item.querySelectorAll('.progress');
        progress.forEach(el => {
          el.classList.add('show-progress');
          let progressBar = el.querySelector('.progress-bar');
          let progressValue = progressBar.getAttribute('aria-valuenow');
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', (e) => {
        if (!themeToggle.contains(e.target) && !themeColors.contains(e.target)) {
    ...
    colorBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            // Update text colors
            heroText.style.color = color;
            heroSubtext.style.color = color;
            
            // Update typed text color
            ...
            // Visual feedback
            colorBtns.forEach(btn => btn.style.transform = 'scale(1)');
